...
_jetPreDQMTaskWithPUPPI = cms.Task(
...
jetMETDQMOfflineSource = cms.Sequence(
                                      ...
                                      dqmAk4PFPuppiL1FastL2L3ResidualCorrectorChain
                                      ####AnalyzeSUSYDQM*QGTagger*
                                      ...
                                      #cms.ignore(CSCTightHaloFilterDQM)*cms.ignore(CSCTightHalo2015FilterDQM)*
                                      #cms.ignore(eeBadScFilterDQM)*cms.ignore(EcalDeadCellTriggerPrimitiveFilterDQM)*
